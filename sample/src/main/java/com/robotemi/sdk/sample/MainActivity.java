...
public class MainActivity extends AppCompatActivity implements
    ...
    private MediaPlayer helloPlayer, locationPlayer, byePlayer;
    ...
    private EditText etSpeak, etDistance;
    private List<String> locations;
    private Robot robot;
    private CustomAdapter mAdapter;
    private TextView tvLog;
    private RelativeLayout homeScreen, locationScreen;
    private ImageView temiFace;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helloPlayer = MediaPlayer.create(this, R.raw.hello);
        locationPlayer = MediaPlayer.create(this, R.raw.location);
        byePlayer = MediaPlayer.create(this, R.raw.bye);
        startDetectionModeWithDistance();
    ...
    public void initViews() {
        ...
        homeScreen = findViewById(R.id.faceScreen);
        temiFace = findViewById(R.id.temiFace);
        locationScreen = findViewById(R.id.locationScreen);
    }
    ...
    public void onDetectionStateChanged(int state) {
        ...
        if (state == OnDetectionStateChangedListener.DETECTED) {
            robot.constraintBeWith(); // Seguimiento a la persona detectada
            temiFace.setImageResource(R.drawable.face_look);
            helloPlayer.start();
            helloPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
                @Override
            ...
            robot.stopMovement();
            byePlayer.start();
            temiFace.setImageResource(R.drawable.face_idle);
            showHomeScreen();
    ...
    private void startDetectionWishDistance() {
        try {
            float distance = Float.parseFloat("0.2");
